...
export default ({ data }) => {
  return (
    <div>
        <Helmet>
        <title>{data.airtable.data.speaker_name + " | REFACTR.TECH 2024"}</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content={data.airtable.data.speaker_name + " | REFACTR.TECH 2024"}
        />
        <meta
  ...
  <meta name="twitter:data2" content="Atlanta, GA" />
        ...
        <meta itemprop="name" content={data.airtable.data.speaker_name + " | REFACTR.TECH 2024"} />
        <meta
