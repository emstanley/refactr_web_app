...
export default ({ data }) => (
  ...
  <div>
  <Helmet>
  <title>Events | REFACTR.TECH 2024</title>
  <meta
    name="description"
  ...
  <meta
    property="og:title"
    content="Events | REFACTR.TECH 2024"
  />
  <meta
  ...
  <meta itemprop="name" content="Events | REFACTR.TECH 2024" />
  <meta
  ...
  />
    ...
    <div className="main-container">
      ...
      <div className="auto-container">
        ...
        <p>We're back with a new lineup of events - meetups, panels, workshops, and social gatherings - catering to all skill levels and interests. Experience the REFACTR.TECH vibe across multiple events all year! No large conference this year, but plenty to look forward to!</p>
